...
{
	SimulationSetting::get()->effectLength = 1.2;
	...
	SearchParticleFactory searchFactory( particles, SimulationSetting::get()->effectLength );
	...
	NeighborSearcher searcher( sorted, SimulationSetting::get()->effectLength );
	searcher.search();
