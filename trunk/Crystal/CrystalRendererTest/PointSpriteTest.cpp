...
BOOST_AUTO_TEST_CASE( POINT_SPRITE_TEST )
{
	...
	BOOST_CHECK( buffer.getColor(0,0) == Color4d( 0.0, 0.0, 0.0 ) );
	BOOST_CHECK_EQUAL( buffer.getDepth(Point2d(0,0)), 0.0f );
	BOOST_CHECK( buffer.getColor(5,5) == Color4d( 1.0, 1.0, 1.0 ) );
